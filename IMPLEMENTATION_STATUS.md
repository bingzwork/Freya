...
| Planning and Reasoning | 🔵 FOUNDATION | 25% |
...
- Migrate from the legacy planner to the new planner framework (Phase 2+): TaskGraph, Scheduler, ResourceAllocator, ProgressTracker integration.
